...
\item[Chapter~\ref{chap:relatedWork&Foundation} -- \nameref{chap:relatedWork&Foundation}:] In this chapter, .

\item[Chapter~\ref{chap:background} -- \nameref{chap:background}:] In this chapter, .

\item[Chapter~\ref{chap:softwareSystem} -- \nameref{chap:softwareSystem}] In this chapter, .
 
\item[Chapter~\ref{chap:evaluation} -- \nameref{chap:evaluation}] In this chapter, .

\item[Chapter~\ref{chap:discussion} -- \nameref{chap:discussion}] In this chapter, .

\item[Chapter~\ref{chap:conclusion} -- \nameref{chap:conclusion}] In this chapter, . %conclusions which were drawn from the work within this thesis and future work is %discussed.
